...
export const useDataStore = defineStore('DataStore', {
  state: () => ({
    images: [
      { src: '@/assets/img/carousel-1.jpg', span: 'col-span-4 row-span-2', alt: 'Twee maal Dark & Stormy cocktail' },
      {
      ...
      { src: '@/assets/img/carousel-6.jpg', span: 'col-span-4 row-span-1', alt: 'Bovenverdieping Inspire Breda' },
      { src: '@/assets/img/carousel-7.jpg', span: 'col-span-2 row-span-1', alt: 'Martini Espresso van bovenaf' },
      { src: '@/assets/img/carousel-8.jpg', span: 'col-span-2 row-span-1', alt: 'Verse appeltaart' }
    ],
    menukaarten: [
      { href: '/menu/lunch-1.pdf', src: '@/assets/img/lunch-1.jpg', name: 'Lunchkaart' },
      { href: '/menu/drank-1.pdf', src: '@/assets/img/drank-1.jpg', name: 'Koffie & Warm' },
      { href: '/menu/drank-2.pdf', src: '@/assets/img/drank-2.jpg', name: 'Sap & Frisdrank' },
      { href: '/menu/drank-3.pdf', src: '@/assets/img/drank-3.jpg', name: 'Bierkaart' },
      { href: '/menu/drank-4.pdf', src: '@/assets/img/drank-4.jpg', name: 'Wijn & Bubbels' },
      { href: '/menu/drank-5.pdf', src: '@/assets/img/drank-5.jpg', name: 'Cocktails' }
    ],
    openingstijden: [
