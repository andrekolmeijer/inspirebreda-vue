  ...
  <section class="m-auto max-w-5xl text-inspire-brown-dark">
    ...
    <div class="mx-8 mt-8">
      ...
      <p class="gap-8 py-8 text-base font-light hyphens-auto sm:columns-2">
        Met uitzicht op de Grote Markt van Breda genieten van de lekkerste
        koffie, gezonde lunch en afsluiten met een speciaalbiertje of de
        perfecte cocktail? Inspire heeft het allemaal in huis! Plof neer op onze
        bank of borrel met vrienden aan onze bartafel. Met de exper&shy;tise van
        ons personeel weet je zeker dat je het juiste drankje voorgeschoteld
        krijgt. Liever een dagje rustig werken? Met onze razendsnelle
        internetverbinding ben je klaar voor elke meeting. Kom gezellig langs en
        laat je inspireren!
      </p>
    </div>
    <div class="sm:mx-8">
      <div
        class="flex h-[300px] snap-x snap-mandatory grid-cols-12 grid-rows-4 flex-row gap-3 overflow-x-auto py-4 scrollbar-hide sm:grid sm:h-[648px]">
        <div
